...
namespace CuponesApiTp.Migrations
{
    ...
    [Migration("20241119132553_CuponesApiTp")]
    partial class CuponesApiTp
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CuponesApiTp.Models.ArticuloModel", b =>
                {
            ...
            modelBuilder.Entity("CuponesApiTp.Models.CategoriaModel", b =>
                {
                    b.Property<int>("Id_Categoria")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CuponesApiTp.Models.CuponModel", b =>
                {
            ...
            modelBuilder.Entity("CuponesApiTp.Models.Cupon_CategoriaModel", b =>
                {
            ...
            modelBuilder.Entity("CuponesApiTp.Models.Cupon_ClienteModel", b =>
                {
            ...
            modelBuilder.Entity("CuponesApiTp.Models.Cupones_DetalleModel", b =>
                {
                    b.Property<int>("Id_Cupon")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CuponesApiTp.Models.Cupones_HistorialModel", b =>
                {
                    b.Property<int>("Id_Cupon")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CuponesApiTp.Models.PrecioModel", b =>
                {
            ...
            modelBuilder.Entity("CuponesApiTp.Models.Tipo_CuponModel", b =>
                {
                    b.Property<int>("Id_Tipo_Cupon")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CuponesApiTp.Models.ArticuloModel", b =>
                {
                    b.HasOne("CuponesApiTp.Models.CategoriaModel", "Categoria")
                        .WithMany("Articulos")
            ...
            modelBuilder.Entity("CuponesApiTp.Models.CuponModel", b =>
                {
                    b.HasOne("CuponesApiTp.Models.Tipo_CuponModel", "Tipo_Cupon")
                        .WithMany()
            ...
            modelBuilder.Entity("CuponesApiTp.Models.Cupon_CategoriaModel", b =>
                {
                    ...
                    b.HasOne("CuponesApiTp.Models.CuponModel", "Cupon")
                        .WithMany("Cupones_Categorias")
            ...
            modelBuilder.Entity("CuponesApiTp.Models.PrecioModel", b =>
                {
                    b.HasOne("CuponesApiTp.Models.ArticuloModel", "Articulo")
                        .WithOne("Precio")
                        .HasForeignKey("CuponesApiTp.Models.PrecioModel", "Id_Articulo")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
